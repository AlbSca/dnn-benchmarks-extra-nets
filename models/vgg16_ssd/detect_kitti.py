...
def detect(
    ...
    if draw:
        ...
        font = ImageFont.truetype(
            "/usr/share/fonts/truetype/abyssinica/AbyssinicaSIL-Regular.ttf", 15
        )
        ...
        for i in range(det_boxes.size(0)):
            ...
            draw.text(
                xy=text_location, text=det_labels[i].upper(), fill="white", font=font
            )
        del draw
...
if __name__ == "__main__":
    img_path = "downloaded_datasets/kitti/testing/image_2/000021.png"
    # Load model checkpoint
    checkpoint_path = "weights/chkpt_kitti_ssd300_230_1.44.pth.tar"
