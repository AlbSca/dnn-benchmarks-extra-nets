...
from vision_models_pytorch.models.resnet50.train import train_resnet50

from vision_models_pytorch.models.vgg16.train import train_vgg16
...
def main():
    ...
    train_loader = DataLoader(
        train_dataset, batch_size=256, shuffle=True, num_workers=8, pin_memory=True, drop_last=True
    )
    valid_loader = DataLoader(
        valid_dataset, batch_size=256, shuffle=False, num_workers=8, pin_memory=True, drop_last=True
    )
    ...
    train_vgg16(
        ...
        weight_decay=1e-4,
        device=device,
        weight_best_path="checkpoints/vgg16_gtsrb_best.pth",
        weight_latest_path="checkpoints/vgg16_gtsrb_latest.pth",
    )
